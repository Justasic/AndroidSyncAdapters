		...
		for (String key : lcCompareItems)
		{
			...
			if (lcValueAndroid != null)
			{
				if (lcValueCalendar != null)
				{
					...
					{
						Log.d(TAG, "difference in " + key.toString() + ":" + lcValueAndroid.toString() + " <> " + lcValueCalendar.toString());
				...
				{
					Log.d(TAG, "difference in " + key.toString() + ":" + lcValueAndroid.toString() + " <> null");
			...
			else
			{
				if (lcValueCalendar != null)
				{
					Log.d(TAG, "difference in " + key.toString() + ":null <> " + lcValueCalendar.toString());
					this.ContentValues.put(key, lcValueCalendar.toString());
					lcResult = true;
				}
				else
