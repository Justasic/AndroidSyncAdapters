...
public class CalendarsHandler extends DefaultHandler
{
	...
	public final static List<String> TAGS = Arrays.asList(HREF, RESOURCETYPE, DISPLAYNAME, GETCTAG, CALENDAR_COLOR);
			...
			if (calendar != null)
			{
				if (HREF.equals(localName))
				{
					...
					catch (URISyntaxException e)
					{
						...
						{
							Log.e(CalendarsHandler.class.getSimpleName(), "calendar-uri malformed: " + calendarUrl);
						}
						else
						{
	...
	{
		return calendar != null && calendar.getURI() != null && calendar.getcTag() != null && calendar.getCalendarDisplayName() != null;
	}
}
