	...
	public void endElement(String uri, String localName, String qName) throws SAXException
	{
		if (HREF.equals(localName) && isInCalendarHomeSet)
		{
			...
			catch (URISyntaxException e)
			{
				...
				{
					Log.e(CalendarHomeHandler.class.getSimpleName(), "uri malformed: " + calendarHomeSet);
				}
				else
				{
					Log.e(CalendarHomeHandler.class.getSimpleName(), "uri malformed in calendar-home-set/href");
				}
			}
		}
		if (CALENDAR_HOME_SET.equals(localName))
