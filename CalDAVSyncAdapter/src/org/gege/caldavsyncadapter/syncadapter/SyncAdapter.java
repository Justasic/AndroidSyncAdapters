...
//		mContext = context;
    ...
    public void onPerformSync(Account account, Bundle extras, String authority,
        ...
        try {
            ...
            CaldavFacade facade = new CaldavFacade(Username, mAccountManager.getPassword(account), url, trust);
            ...
            for (DavCalendar serverCalendar : serverCalList.getCalendarList()) {
                Log.i(TAG, "Detected calendar name=" + serverCalendar.getCalendarDisplayName() + " URI=" + serverCalendar
                        .getURI());

                Uri androidCalendarUri = serverCalendar.checkAndroidCalendarList(androidCalList, this
                        .getContext());
                ...
                if (androidCalendarUri != null) {
                    ...
                    this.checkDirtyAndroidEvents(provider, account, androidCalendarUri, facade, serverCalendar
